...
#! taken from https://github.com/DengPingFan/Polyp-PVT/blob/57394b7bc20b171aa07884b110cd5a51919f3448/lib/pvt.py
...
class PolypPVT(nn.Module):
    ...
    def forward(self, x):
        ...
        return prediction1_8, prediction2_8, prediction2_8
